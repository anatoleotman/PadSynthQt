...
EnvelopeGenerator::EnvelopeGenerator(QObject *parent) : QObject(parent),
    minimumLevel(0.0001),
    ...
    nextStageSampleIndex(0)
{
    ...
    stageValue[ENVELOPE_STAGE_DECAY] = 2.;
...
void EnvelopeGenerator::setStageValue(EnvelopeGenerator::EnvelopeStage stage, double value)
{
    this->stageValue[stage] = value;
}
